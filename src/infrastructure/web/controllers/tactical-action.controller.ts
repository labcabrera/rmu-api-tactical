...
export class TacticalActionController {
    ...
    async findActions(req: Request, res: Response) {
        try {
            const query: TacticalActionQuery = {
                ...(req.query.gameId && { gameId: req.query.gameId as string }),
                ...(req.query.round && { round: parseInt(req.query.round as string) }),
                ...(req.query.characterId && { characterId: req.query.characterId as string }),
                ...(req.query.actionType && { actionType: req.query.actionType as string }),
