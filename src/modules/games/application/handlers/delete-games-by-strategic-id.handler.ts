...
import { DeleteGamesByStrategicIdCommand } from '../cqrs/commands/delete-games-by-strategic-id.command';
...
export class DeleteGamesByStrategicIdHandler implements ICommandHandler<DeleteGamesByStrategicIdCommand> {
  ...
  constructor(
    ...
    @Inject('GameEventProducer') private readonly gameBus: gep.GameEventBusPort,
